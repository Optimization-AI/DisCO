...
📢 **[Oct 2025]:**
Building on DisCO framework, we developed an **efficient reasoning** method that achieves **77% length reduction** on simple GSM8k dataset using a 1.5B model, while maintaining DisCO's strong performance. Refer to [Paper](https://www.arxiv.org/abs/2510.04474) and [Code](https://github.com/Optimization-AI/DRPO).
