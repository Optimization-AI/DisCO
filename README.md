...
📢 **[Oct 2025]:**
We developed an **efficient reasoning** method that achieves **77% length reduction** on simple GSM8k dataset using a 1.5B model, while maintaining DisCO's strong performance. This work is accepted to ICLR 2026. Refer to [Paper](https://www.arxiv.org/abs/2510.04474) and [Code](https://github.com/Optimization-AI/DRPO).
