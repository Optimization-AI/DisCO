...
📢 **Update (Sep 2025):**
To help users utilize our work with the **latest versions of vLLM and Verl**, we’ve opened a pull request in the Verl repository. Feel free to check it out! [Pull Request](https://github.com/volcengine/verl/pull/3357)
